...
class Schedule(models.Model):
    ...
    DepartureTime = models.TimeField(auto_now=False, auto_now_add=False, default='18:00')
    ArrivalTime = models.TimeField(auto_now=False, auto_now_add=False, default='06:00')
